  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 p-4 bg-brand-secondary text-white rounded-full shadow-lg hover:bg-brand-secondary/90 transition-all duration-300 hover:scale-110 active:scale-95 group"
      >
        ...
        <div className="fixed bottom-24 right-6 z-50 w-80 bg-white rounded-2xl shadow-xl border border-stone-100 overflow-hidden animate-fade-in-up">
          <div className="bg-brand-secondary p-4 text-white flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-orange-100">Usually replies in 5 mins</p>
            </div>
          ...
          <div className="p-4 border-t border-stone-100 bg-white">
            <input
              ...
              className="w-full px-4 py-2 bg-stone-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-brand-secondary"
            />
          </div>
        </div>
      )}
